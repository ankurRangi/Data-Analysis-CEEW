...
#Base Year
d2005 <- subset(ind_thai, year == "2005", select = c("year", "import_value", "hs_product_code"))

d2010 <- subset(ind_thai, year == "2010", select = c("year", "import_value", "hs_product_code"))
d2013 <- subset(ind_thai, year == "2013", select = c("year", "import_value", "hs_product_code"))
d2017 <- subset(ind_thai, year == "2017", select = c("year", "import_value", "hs_product_code"))
...
write.csv(fdat, "D:/CEEW/Data/Data_Summary/PHIL/THAI_CAGR.csv", row.names = FALSE)
