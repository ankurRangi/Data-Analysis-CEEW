...
#Base Year
d2005 <- subset(ind_sgp, year == "2005", select = c("year","export_value", "import_value", "hs_product_code"))

d2010 <- subset(ind_sgp, year == "2010", select = c("year","export_value", "import_value", "hs_product_code"))
d2013 <- subset(ind_sgp, year == "2013", select = c("year","export_value", "import_value", "hs_product_code"))
d2017 <- subset(ind_sgp, year == "2017", select = c("year","export_value", "import_value", "hs_product_code"))
...
write.csv(fdat, "D:/CEEW/Data/Data_Summary/IND_SGP_CHN/Exp_Imp_CAGR_10_13_17.csv", row.names = FALSE)
