...
imp_primary1 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Primary.xlsx", 1)
imp_primary2 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Primary.xlsx", 2)
imp_primary3 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Primary.xlsx", 3)
imp_primary4 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Primary.xlsx", 4)
imp_primary5 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Primary.xlsx", 5)

imp_product1 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 1)
imp_product2 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 2)
imp_product3 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 3)
imp_product4 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 4)
imp_product5 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 5)
imp_product6 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 6)
imp_product7 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 7)
imp_product8 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 8)
imp_product9 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 9)
imp_product10 <- read_xlsx("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Product.xlsx", 10)
...
#write.csv(primary_country, "D:/CEEW/Data/Analysis/Copper/2015-16/Exports/CombinedPrimary.csv", row.names = TRUE)
...
for(i in 1:NROW(product_country)){
  ...
  for(j in 1:NROW(imp_product10)){
    if(imp_product10$Country[j] == product_country$Country[i]){
      counter16 = counter16 + imp_product10$`2015-2016`[j]
      counter17 = counter17 + imp_product10$`2016-2017`[j]
    }
  }
  c16[i] <- counter16
  c17[i] <- counter17
...
write.csv(product_country, "D:/CEEW/Data/Analysis/Copper/2015-16/Exports/CombinedProduct.csv", row.names = TRUE)
#__________
...
#_____
library(readxl)
exp_product <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/CombinedProduct.xlsx",1)
exp_primary <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/CombinedPrimary.xlsx",1)
exp_scrap <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/scrap.xlsx", 1)
exp_ores <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Ore.xlsx", 1)
...
write.csv(country, "D:/CEEW/Data/Analysis/Copper/2015-16/Exports/Final_data.csv", row.names = TRUE)

#_________

library(readxl)
imp_product <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Imports/CombinedProduct.xlsx", 1)
imp_primary <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Imports/CombinedPrimary.xlsx", 1)
imp_scrap <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Imports/scrap.xlsx", 1)
imp_ores <- read_excel("D:/CEEW/Data/Analysis/Copper/2015-16/Imports/Ore.xlsx", 1)
...
for(i in 1:NROW(country)){
  if(length(imp_primary$val15[imp_primary$Country == country$country[i]]) != 0){
    primary_16[i] <- imp_primary$val15[imp_primary$Country == country$country[i]]
  }else{
    primary_16[i] <- 0
  }
  if(length(imp_primary$val16[imp_primary$Country == country$country[i]]) != 0){
    primary_17[i] <- imp_primary$val16[imp_primary$Country == country$country[i]]
  }else{
    primary_17[i] <- 0
  }
  ...
  if(length(imp_product$val15[imp_product$Country == country$country[i]]) != 0){
    product_16[i] <- imp_product$val15[imp_product$Country == country$country[i]]
  }else{
    product_16[i] <- 0
  }
  if(length(imp_product$val16[imp_product$Country == country$country[i]]) != 0){
    product_17[i] <- imp_product$val16[imp_product$Country == country$country[i]]
  }else{
    product_17[i] <- 0
  }
  ...
  if(length(imp_scrap$`2015-2016`[imp_scrap$Country == country$country[i]]) != 0){
    scrap_16[i] <- imp_scrap$`2015-2016`[imp_scrap$Country == country$country[i]]
  }else{
    scrap_16[i] <- 0
  }
  if(length(imp_scrap$`2016-2017`[imp_scrap$Country == country$country[i]]) != 0){
    scrap_17[i] <- imp_scrap$`2016-2017`[imp_scrap$Country == country$country[i]]
  }else{
    scrap_17[i] <- 0
  }
  ...
  if(length(imp_ores$`2015-2016`[imp_ores$Country == country$country[i]]) != 0){
    ores_16[i] <- imp_ores$`2015-2016`[imp_ores$Country == country$country[i]]
  }else{
    ores_16[i] <- 0
  }
  if(length(imp_ores$`2016-2017`[imp_ores$Country == country$country[i]]) != 0){
    ores_17[i] <- imp_ores$`2016-2017`[imp_ores$Country == country$country[i]]
  }else{
    ores_17[i] <- 0
  }
...
write.csv(country, "D:/CEEW/Data/Analysis/Copper/2015-16/Imports/Final_data.csv", row.names = TRUE)
